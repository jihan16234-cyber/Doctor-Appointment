...
<head>
    ...
    <style>
        ...
        .fixed-bg-layer {
            ...
            height: 100vh; 
            z-index: -1;
            overflow: hidden; /* Important so zoom doesn't cause scrollbars */
        }
        ...
        .bg-image {
            ...
            /* The requested Drift Zoom Animation */
        ...
        @keyframes drift-zoom {
            ...
            50% {
                background-size: 120% auto; /* Slight Zoom In */
                background-position: 50% 30%; /* Pan Up */
            }
            100% {
                background-size: 120% auto; /* Zoom Out */
                background-position: 60% 50%; /* Pan Right */
            }
        }

        /* Mobile fallback for background */
        ...
        /* New: Glass Card (Lighter, interactive) */
        .glass-card {
        ...
        /* Standard Glass Panel (Darker, static) */
        .glass-panel {
