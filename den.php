...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --color-dark-blue: rgba(101, 101, 238, 0.8); 
            --color-solid-dark-blue: #558cebff; 
                       ...
                       <table id="doctorTable" class="min-w-full divide-y divide-white/30">
                            ...
                            <tbody class="divide-y divide-white/20 text-white">
                                <tr class="hover:bg-white/10">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">Dr. Amelia Reed</td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium"><a href="#" class="text-white hover:text-gray-300" onclick="showDoctorProfileModal('Dr. Amelia Reed'); return false;">View Profile</a></td>
                                </tr>
                                <tr class="hover:bg-white/10">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">Dr. Ben Carter</td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium"><a href="#" class="text-white hover:text-gray-300" onclick="showDoctorProfileModal('Dr. Ben Carter'); return false;">View Profile</a></td>
                                </tr>
                                <tr class="hover:bg-white/10">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">Dr. Chloe Diaz</td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium"><a href="#" class="text-white hover:text-gray-300" onclick="showDoctorProfileModal('Dr. Chloe Diaz'); return false;">View Profile</a></td>
                                </tr>
                                <tr class="hover:bg-white/10">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">Dr. David Chen</td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium"><a href="#" class="text-white hover:text-gray-300" onclick="showDoctorProfileModal('Dr. David Chen'); return false;">View Profile</a></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div id="booking-step-1" class="booking-step">
                        ...
                        <div class="space-y-4">
                            <div class="p-4 bg-white/10 rounded-lg flex justify-between items-center border border-white/20">
                                <div>
                                    <p class="font-semibold text-white">Dr. Amelia Reed, MD</p>
                            ...
                            <div class="p-4 bg-white/10 rounded-lg flex justify-between items-center border border-white/20">
                                <div>
                                    <p class="font-semibold text-white">Dr. Ben Carter, MD</p>
                            ...
                            <div class="p-4 bg-white/10 rounded-lg flex justify-between items-center border border-white/20">
                                <div>
                                    <p class="font-semibold text-white">Dr. Sarah Jenkins, MBBS</p>
                            ...
                            <div class="p-4 bg-white/5 rounded-lg flex justify-between items-center border border-white/10 opacity-60">
                                <div>
                                    <p class="font-semibold text-white">Dr. John Doe (Unavailable)</p>
    ...
    <script>
        ...
        const DOCTOR_DATA = {
            'Dr. Amelia Reed': {
                ...
                image: 'https://images.unsplash.com/photo-1559839734-2b7194cb94ad?fit=crop&w=128&q=80', // Placeholder image URL
            ...
            'Dr. Ben Carter': {
                ...
                image: 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?fit=crop&w=128&q=80', // Placeholder image URL
            ...
            'Dr. Chloe Diaz': {
                ...
                image: 'https://images.unsplash.com/photo-1621426462947-a87796d13d71?fit=crop&w=128&q=80', // Placeholder image URL
