...
<head>
    ...
    .fixed-background {
        ...
        */
        ...
        background-image: 
            linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), /* Darker overlay for better contrast */
...
<body>
    ...
    <main class="content-area">
        ...
        <section id="dashboard" class="content-section">
            ...
            <div class="glass-card-item">
                ...
                <ul>
                    ...
                    <li>New maintenance ticket: Leaky Faucet (Room 101).</li>
                </ul>
            ...
            <div class="card-grid">
                ...
                <div class="glass-card-item">
                    ...
                    <ul>
                        <li><strong style="color: #ffccbc;">Tenant A</strong> (Room 101) - $500 (Due Oct)</li>
                        <li><strong style="color: #ffccbc;">Tenant B</strong> (Room 302) - $400 (Due Sep)</li>
                    </ul>
        ...
        <section id="roommgmt" class="glass-card content-section">
        ...
        <section id="myhostels" class="glass-card content-section">
            ...
            <div class="glass-card-item room-card">
                ...
                <ul>
                    ...
                    <li>**Tenant's details**: John Doe (View Profile)</li>
        ...
        <section id="bookings" class="glass-card content-section">
            ...
            <div class="glass-card-item">
                ...
                <p>New request from Mary Smith for Room 302.</p>
        ...
        <section id="subscription" class="glass-card content-section">
